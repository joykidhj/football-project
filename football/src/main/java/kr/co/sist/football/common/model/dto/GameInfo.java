...
public class GameInfo {
	...
	public String toString() {
		return "GameInfo [id=" + id + ", statusCode=" + statusCode + ", maxPersonNum=" + maxPersonNum + ", maxTeamNum="
				+ maxTeamNum + ", kind=" + kind + ", gameDate=" + gameDate + ", duration=" + duration + ", description="
				+ description + ", maxnumTeam=" + maxnumTeam + ", name=" + name + "]";
	}
